...
return static function (ContainerConfigurator $containerConfigurator): void {
    ...
    $services->set(ExtEmConfRector::class)->call('configure', [[
    ...
    $services->set(ExtbasePersistenceTypoScriptRector::class)->call('configure', [[
        ExtbasePersistenceTypoScriptRector::FILENAME => 'Configuration/Extbase/Persistence/Classes.php'
    ]]);
};
